...
export const TICKER_ITEMS = [
  'BREAKING: Fluent Cantonese Speaker',
  'JUST IN: GPA 3.8 at BYU',
  'LATEST: Python & C++ Engineer',
  'DEVELOPING: BJJ Practitioner',
  'LIVE: Linux (Kali & Ubuntu) Specialist',
  'UPDATE: Raspberry Pi Hardware Lab',
  'ALERT: SQL & Power BI Data Stack',
  'REPORT: Former Volunteer Rep in Hong Kong',
];
...
export const PROJECTS = [
  ...
  },
  {
    ...
    headline: 'AI-Driven Linguistics: Bridging the Cantonese-English Divide',
    byline: 'By Carter Lee  |  Language & Technology',
    summary:
      'Developing tools based on international service experience to facilitate Cantonese-English language acquisition.',
    tags: ['Python', 'NLP', 'Cantonese', 'Language Tech'],
    link: '#',
    featured: false,
  },
  {
